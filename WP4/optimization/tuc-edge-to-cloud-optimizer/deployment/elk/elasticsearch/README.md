...
On distributions which have SELinux enabled out-of-the-box you will need to either re-traverser.context the files or set SELinux
into Permissive mode in order for docker-elk to start properly. For example on Redhat and CentOS, the following will
apply the proper traverser.context:
...
[config-es]: config/elasticsearch.yml
[config-kbn]: ../kibana/config/kibana.yml
[config-ls]: ../logstash/logstash.yml
