package core.statistics.platform.Yarn;
...
public class App {
    ...
    //The aggregated amount of memory (in megabytes) the application has allocated times the number of seconds the application has been running.
