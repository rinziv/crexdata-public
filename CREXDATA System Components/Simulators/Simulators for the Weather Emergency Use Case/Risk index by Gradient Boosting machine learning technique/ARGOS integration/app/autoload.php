...
function hydsApplicationsCustomAutoLoad($class_name)
{
    ...
    $iter = new RecursiveIteratorIterator(
        new RecursiveDirectoryIterator(__APP_PATH__ . '/app', RecursiveDirectoryIterator::SKIP_DOTS | \FilesystemIterator::SKIP_DOTS),
    ...
    $iter = new RecursiveIteratorIterator(
        new RecursiveDirectoryIterator($lib_path, RecursiveDirectoryIterator::SKIP_DOTS | \FilesystemIterator::SKIP_DOTS),
        RecursiveIteratorIterator::SELF_FIRST,
        RecursiveIteratorIterator::CATCH_GET_CHILD /* Ignore "Permission denied" */
    );
    foreach ($iter as $dir) {
