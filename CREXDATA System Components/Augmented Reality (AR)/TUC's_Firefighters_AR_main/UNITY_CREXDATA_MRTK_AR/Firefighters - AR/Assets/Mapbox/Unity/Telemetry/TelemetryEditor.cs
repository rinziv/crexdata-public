...
namespace Mapbox.Unity.Telemetry
{
	...
	public class TelemetryEditor : ITelemetryLibrary
	{
		...
		IEnumerator PostWWW(string url, string bodyJsonString)
		{
			...
			// www doesn't expose HTTP status code, rely on 'error' property
