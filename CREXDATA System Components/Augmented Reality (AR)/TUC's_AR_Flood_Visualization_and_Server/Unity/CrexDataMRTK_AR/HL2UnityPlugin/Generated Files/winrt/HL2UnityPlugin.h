...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(com_array<float>) consume_HL2UnityPlugin_IHL2ResearchMode<D>::GetAccelSample() const
    {
        uint32_t result_impl_size{};
        float* result{};
        check_hresult(WINRT_IMPL_SHIM(HL2UnityPlugin::IHL2ResearchMode)->GetAccelSample(&result_impl_size, &result));
        return com_array<float>{ result, result_impl_size, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(com_array<float>) consume_HL2UnityPlugin_IHL2ResearchMode<D>::GetGyroSample() const
    {
        uint32_t result_impl_size{};
        float* result{};
        check_hresult(WINRT_IMPL_SHIM(HL2UnityPlugin::IHL2ResearchMode)->GetGyroSample(&result_impl_size, &result));
        return com_array<float>{ result, result_impl_size, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(com_array<float>) consume_HL2UnityPlugin_IHL2ResearchMode<D>::GetMagSample() const
    {
        uint32_t result_impl_size{};
        float* result{};
        check_hresult(WINRT_IMPL_SHIM(HL2UnityPlugin::IHL2ResearchMode)->GetMagSample(&result_impl_size, &result));
        return com_array<float>{ result, result_impl_size, take_ownership_from_abi };
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(bool) consume_HL2UnityPlugin_IHL2ResearchMode<D>::AccelSampleUpdated() const
    {
        bool result{};
        check_hresult(WINRT_IMPL_SHIM(HL2UnityPlugin::IHL2ResearchMode)->AccelSampleUpdated(&result));
        return result;
    }
    template <typename D> WINRT_IMPL_AUTO(bool) consume_HL2UnityPlugin_IHL2ResearchMode<D>::GyroSampleUpdated() const
    {
        bool result{};
        check_hresult(WINRT_IMPL_SHIM(HL2UnityPlugin::IHL2ResearchMode)->GyroSampleUpdated(&result));
        return result;
    }
    template <typename D> WINRT_IMPL_AUTO(bool) consume_HL2UnityPlugin_IHL2ResearchMode<D>::MagSampleUpdated() const
    {
        bool result{};
        check_hresult(WINRT_IMPL_SHIM(HL2UnityPlugin::IHL2ResearchMode)->MagSampleUpdated(&result));
        return result;
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_HL2UnityPlugin_IHL2ResearchMode<D>::InitializeAccelSensor() const
    {
        check_hresult(WINRT_IMPL_SHIM(HL2UnityPlugin::IHL2ResearchMode)->InitializeAccelSensor());
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_HL2UnityPlugin_IHL2ResearchMode<D>::InitializeGyroSensor() const
    {
        check_hresult(WINRT_IMPL_SHIM(HL2UnityPlugin::IHL2ResearchMode)->InitializeGyroSensor());
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_HL2UnityPlugin_IHL2ResearchMode<D>::InitializeMagSensor() const
    {
        check_hresult(WINRT_IMPL_SHIM(HL2UnityPlugin::IHL2ResearchMode)->InitializeMagSensor());
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_HL2UnityPlugin_IHL2ResearchMode<D>::StartAccelSensorLoop() const
    {
        check_hresult(WINRT_IMPL_SHIM(HL2UnityPlugin::IHL2ResearchMode)->StartAccelSensorLoop());
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_HL2UnityPlugin_IHL2ResearchMode<D>::StartGyroSensorLoop() const
    {
        check_hresult(WINRT_IMPL_SHIM(HL2UnityPlugin::IHL2ResearchMode)->StartGyroSensorLoop());
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_HL2UnityPlugin_IHL2ResearchMode<D>::StartMagSensorLoop() const
    {
        check_hresult(WINRT_IMPL_SHIM(HL2UnityPlugin::IHL2ResearchMode)->StartMagSensorLoop());
    }
