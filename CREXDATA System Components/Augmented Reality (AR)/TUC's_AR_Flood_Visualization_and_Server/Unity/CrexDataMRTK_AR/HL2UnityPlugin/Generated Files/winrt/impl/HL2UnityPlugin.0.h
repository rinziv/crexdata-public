...
namespace winrt::impl
{
    ...
    template <> inline constexpr guid guid_v<HL2UnityPlugin::IHL2ResearchMode>{ 0x059253D9,0x25DE,0x519B,{ 0xA2,0x4C,0xAE,0x37,0x0D,0x5D,0x33,0xCF } }; // 059253D9-25DE-519B-A24C-AE370D5D33CF
    ...
    struct consume_HL2UnityPlugin_IHL2ResearchMode
    {
        ...
        WINRT_IMPL_AUTO(com_array<float>) GetAccelSample() const;
        WINRT_IMPL_AUTO(com_array<float>) GetGyroSample() const;
        WINRT_IMPL_AUTO(com_array<float>) GetMagSample() const;
        ...
        WINRT_IMPL_AUTO(bool) AccelSampleUpdated() const;
        WINRT_IMPL_AUTO(bool) GyroSampleUpdated() const;
        WINRT_IMPL_AUTO(bool) MagSampleUpdated() const;
        ...
        WINRT_IMPL_AUTO(void) InitializeAccelSensor() const;
        WINRT_IMPL_AUTO(void) InitializeGyroSensor() const;
        WINRT_IMPL_AUTO(void) InitializeMagSensor() const;
        ...
        WINRT_IMPL_AUTO(void) StartAccelSensorLoop() const;
        WINRT_IMPL_AUTO(void) StartGyroSensorLoop() const;
        WINRT_IMPL_AUTO(void) StartMagSensorLoop() const;
