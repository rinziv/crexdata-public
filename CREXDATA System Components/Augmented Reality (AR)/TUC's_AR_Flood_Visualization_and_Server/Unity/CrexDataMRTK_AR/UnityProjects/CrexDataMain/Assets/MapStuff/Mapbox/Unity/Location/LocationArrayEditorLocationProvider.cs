namespace Mapbox.Unity.Location
{
	...
	public class LocationArrayEditorLocationProvider : AbstractEditorLocationProvider
	{
		...
		public void UpdateLocation(double latitude, double longitude, int index)
		{
			...
			Debug.Log("UpdateLocation: " + latStr + ", " + lonStr);
			if (index >= 0 && index < _latitudeLongitude.Length)
			{
				_latitudeLongitude[index] = latStr + ", " + lonStr;
			}
		}
	}
}
